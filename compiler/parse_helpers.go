...
func (c *Compiler) ToFormula(s string) (lg.Node, error) {
...
func (c *Compiler) ToFormulaV(s string, version lexer.Version) (lg.Node, error) {
...
func (c *Compiler) ToClause(s string) ([]lg.Node, error) {
	f, err := c.ToFormula(s)
	if err != nil {
		return nil, err
	}
...
func (c *Compiler) ToLiteral(s string) (lg.Node, error) {
	f, err := c.ToFormula(s)
	if err != nil {
		return nil, err
	}
