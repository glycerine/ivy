...
Checker.prototype.instance = function instanceMethod(pos, orig, targs, expanding, ctxt) {
...
Checker.prototype.validateTArgLen = function validateTArgLenMethod(pos, name, want, got) {
...
Checker.prototype.verify = function verifyMethod(pos, tparams, targs, ctxt) {
...
Checker.prototype.implements = function implementsMethod(V, T, constraint, cause) {
