...
export class Hasher {
    ...
    Equal(x, y) { return Identical(x, y); }
}
export class HasherIgnoreTags {
    ...
    Equal(x, y) { return IdenticalIgnoreTags(x, y); }
}
