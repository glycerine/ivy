...
Interface.prototype.Methods = function Methods() {
    return (yield_) => {
...
Interface.prototype.ExplicitMethods = function ExplicitMethods() {
    return (yield_) => {
...
Interface.prototype.EmbeddedTypes = function EmbeddedTypes() {
    return (yield_) => {
...
//
// Example: for m := range t.Methods() { ... }
Named.prototype.Methods = function Methods() {
    return (yield_) => {
        for (let i = 0; i < this.NumMethods(); i++) {
            if (!yield_(this.Method(i))) {
                break;
...
Scope.prototype.Children = function Children() {
    return (yield_) => {
...
Struct.prototype.Fields = function Fields() {
    return (yield_) => {
...
Tuple.prototype.Variables = function Variables() {
    return (yield_) => {
...
MethodSet.prototype.Methods = function Methods() {
    return (yield_) => {
        for (let i = 0; i < this.Len(); i++) {
            if (!yield_(this.At(i))) {
                break;
...
Union.prototype.Terms = function Terms() {
    return (yield_) => {
        for (let i = 0; i < this.Len(); i++) {
...
TypeParamList.prototype.TypeParams = function TypeParams() {
    return (yield_) => {
        for (let i = 0; i < this.Len(); i++) {
            if (!yield_(this.At(i))) {
                break;
...
TypeList.prototype.Types = function Types() {
    return (yield_) => {
        for (let i = 0; i < this.Len(); i++) {
            if (!yield_(this.At(i))) {
                break;
