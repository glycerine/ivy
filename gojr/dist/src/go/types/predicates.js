...
import { Basic, BasicKind, IsBoolean, IsComplex, IsConstType, IsFloat, IsInteger, IsNumeric, IsOrdered, IsString, IsUnsigned, IsUntyped } from "./basic.js";
...
import { typeErrorf, underIs } from "./under.js";
...
export function isValid(t) { return aliasTypes.Unalias(t) !== Typ[BasicKind.Invalid]; }
// The isX predicates below report whether t is an X.
// If t is a type parameter the result is false; i.e.,
// these predicates don't look inside a type parameter.
export function isBoolean(t) { return isBasic(t, IsBoolean); }
export function isInteger(t) { return isBasic(t, IsInteger); }
export function isUnsigned(t) { return isBasic(t, IsUnsigned); }
export function isFloat(t) { return isBasic(t, IsFloat); }
export function isComplex(t) { return isBasic(t, IsComplex); }
export function isNumeric(t) { return isBasic(t, IsNumeric); }
export function isString(t) { return isBasic(t, IsString); }
export function isIntegerOrFloat(t) { return isBasic(t, IsInteger | IsFloat); }
export function isConstType(t) { return isBasic(t, IsConstType); }
// isBasic reports whether t.Underlying() is a basic type with the specified info.
// If t is a type parameter the result is false; i.e.,
// isBasic does not look inside a type parameter.
export function isBasic(t, info) {
...
export function allBoolean(t) { return allBasic(t, IsBoolean); }
export function allInteger(t) { return allBasic(t, IsInteger); }
export function allUnsigned(t) { return allBasic(t, IsUnsigned); }
export function allNumeric(t) { return allBasic(t, IsNumeric); }
export function allString(t) { return allBasic(t, IsString); }
export function allOrdered(t) { return allBasic(t, IsOrdered); }
export function allNumericOrString(t) { return allBasic(t, IsNumeric | IsString); }
// allBasic reports whether t.Underlying() is a basic type with the specified info.
// If t is a type parameter, the result is true if isBasic(t, info) is true
// for all specific types of the type parameter's type set.
export function allBasic(t, info) {
...
// Safe to call from types that are not fully set up.
export function isUntypedNumeric(t) {
    // Alias and named types cannot denote untyped types
    // so there's no need to call Unalias or Underlying, below.
    const b = t instanceof Basic ? t : null;
...
export function isNonTypeParamInterface(t) {
...
// computed yet.
export function hasEmptyTypeset(t) {
    const tpar = aliasTypes.Unalias(t);
...
export function comparableType(T, dynamic, seen) {
    if (seen?.get(T)) {
        return null;
    }
    if (seen === null) {
    ...
    identical(x0, y0, p) {
        ...
        if (x instanceof Basic) {
            ...
            if ((x.TypeParams()?.Len() ?? 0) > 0) {
                ...
                yparams = substType(null, nopos, y.params, smap, null, ctxt);
                yresults = substType(null, nopos, y.results, smap, null, ctxt);
            }
...
export function identicalOrigin(x, y) {
...
// identical.
export function identicalInstance(xorig, xargs, yorig, yargs) {
    if (xargs.length !== yargs.length) {
        return false;
    }
    for (let i = 0; i < xargs.length; i++) {
