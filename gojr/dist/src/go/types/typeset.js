...
import { atPos, debug, nopos } from "./check.js";
...
export class _TypeSet {
    ...
    terms = allTermlist, // type terms of the type set
...
export function computeInterfaceTypeSet(check, pos, ityp) {
    if (ityp.tset !== null) {
        return ityp.tset;
    }
...
function computeInterfaceTypeSetBody(check, pos, ityp) {
    ...
    let allMethods = [];
    const mpos = new Map(); // method specification or method embedding position, for good error messages
...
export function intersectTermLists(xterms, xcomp, yterms, ycomp) {
...
export function sortMethods(list) {
    list.sort(compareFunc);
}
export function assertSortedMethods(list) {
    if (!debug) {
...
export function computeUnionTypeSet(check, unionSets, pos, utyp) {
