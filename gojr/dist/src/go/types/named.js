...
export class Named {
    ...
    expandMethod(i) {
        ...
        if (rtpars.length === rtargs.length) {
            ...
            newSig = substType(check, orig.pos, oldSig, smap, this, ctxt);
        }
        if (newSig === oldSig) {
...
Checker.prototype.newNamed = function newNamedMethod(obj, fromRHS, methods) {
...
Checker.prototype.newNamedInstance = function newNamedInstanceMethod(pos, orig, targs, expanding) {
...
Checker.prototype.context = function context() {
    if (this.ctxt === null) {
