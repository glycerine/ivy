...
import { WriteSignature, WriteType } from "./typestring.js";
...
function cloneSignature(sig) {
    return Object.assign(Object.create(Object.getPrototypeOf(sig)), sig);
}
function cloneVar(v) {
...
export function SelectionString(s, qf) {
    let k;
    switch (s.kind) {
