...
Config.prototype.alignof = function alignof(T) {
...
Config.prototype.offsetsof = function offsetsof(T) {
    let offsets = [];
    if (T.NumFields() > 0) {
...
Config.prototype.offsetof = function offsetof(T, index) {
    let offs = 0;
...
Config.prototype.sizeof = function sizeof(T) {
