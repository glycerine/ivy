...
export function setObjectNamedConstructor(ctor) {
    objectRuntimeDeps().Named = ctor;
}
export function setObjectSignatureConstructor(ctor) {
    objectRuntimeDeps().Signature = ctor;
}
export function setObjectTypePrinters(printers) {
    Object.assign(objectRuntimeDeps(), printers);
}
export function setObjectIdentical(fn) {
    objectRuntimeDeps().Identical = fn;
}
export function setObjectEmptyInterface(typ) {
    objectRuntimeDeps().emptyInterface = typ;
}
export function setObjectUniverseDeps(deps) {
