...
registerCheckerMethod("validType", function validType(typ) {
...
registerCheckerMethod("validType0", function validType0(pos, typ0, nest0, path0) {
...
registerCheckerMethod("validType0Body", function validType0Body(pos, typ, nest, path) {
    switch (true) {
        case typ === null:
