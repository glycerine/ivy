...
Current same-kind exact-symbol audit: 977/1121 upstream go/types declarations have a matching symbol in the current TypeScript inventory; 144 are missing by exact symbol name.
...
Generated from Go source using /private/tmp/go_types_inventory_127.json; TypeScript symbols were collected with the TypeScript compiler API from 63 fresh-port files.
