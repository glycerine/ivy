...
Current same-kind exact-symbol audit: 644/1121 upstream go/types declarations have a matching symbol in the current TypeScript inventory; 477 are missing by exact symbol name.
...
Generated from Go source using /private/tmp/go_types_inventory_127.json; TypeScript symbols were collected with the TypeScript compiler API from 44 fresh-port files.
...
- `fset` - Present: Property fset on Checker (gojr/src/go/types/check.ts); Variable fset (gojr/src/go/types/format.ts); Variable fset (gojr/src/go/types/struct.ts) - logic: declaration-only
...
- `lookupFieldOrMethod` @ /usr/local/go1.27rc1/src/go/types/lookup.go:97:1 - Missing from current checker same-kind exact-symbol inventory - control-flow shape: if=6, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=9, return=3, defer=0, go=0, call=7, binary=6, unary=1, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
...
#### Variables
- `topTypeSet` - Present: Variable topTypeSet (gojr/src/go/types/interface.ts) - logic: declaration-only
- `invalidTypeSet` - Missing from current checker same-kind exact-symbol inventory - logic: declaration-only

#### Types
- `_TypeSet` (struct) - Present: ClassDeclaration _TypeSet (gojr/src/go/types/interface.ts) - structure: not yet 1:1-audited
