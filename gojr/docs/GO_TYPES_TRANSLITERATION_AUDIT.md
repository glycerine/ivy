...
#### Constants
- `invalidArg` - Present: Variable invalidArg (gojr/src/go/types/errors.ts); Variable invalidArg (gojr/src/go/types/index_expr.ts) - logic: declaration-only
- `invalidOp` - Present: Variable invalidOp (gojr/src/go/types/errors.ts); Variable invalidOp (gojr/src/go/types/expr.ts); Variable invalidOp (gojr/src/go/types/index_expr.ts) - logic: declaration-only
...
#### Variables
- `unaryOpPredicates` - Present: Variable unaryOpPredicates (gojr/src/go/types/expr.ts) - logic: declaration-only
- `op2str1` - Present: Variable op2str1 (gojr/src/go/types/expr.ts) - logic: declaration-only
- `op2str2` - Present: Variable op2str2 (gojr/src/go/types/expr.ts) - logic: declaration-only
- `binaryOpPredicates` - Present: Variable binaryOpPredicates (gojr/src/go/types/expr.ts) - logic: declaration-only

#### Types
- `opPredicates` (*ast.MapType) - Present: TypeAliasDeclaration opPredicates (gojr/src/go/types/expr.ts) - structure: not yet 1:1-audited
- `exprKind` (*ast.Ident) - Present: EnumDeclaration exprKind (gojr/src/go/types/universe.ts) - structure: not yet 1:1-audited
- `target` (struct) - Present: ClassDeclaration target (gojr/src/go/types/expr.ts) - structure: not yet 1:1-audited
...
- `opPos` @ /usr/local/go1.27rc1/src/go/types/expr.go:88:1 - Present: FunctionDeclaration opPos (gojr/src/go/types/expr.ts) - control-flow shape: if=0, for=0, range=0, switch=0, typeSwitch=1, select=0, branch=0, assign=1, return=3, defer=0, go=0, call=1, binary=0, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `opName` @ /usr/local/go1.27rc1/src/go/types/expr.go:101:1 - Present: FunctionDeclaration opName (gojr/src/go/types/const.ts); FunctionDeclaration opName (gojr/src/go/types/expr.ts) - control-flow shape: if=2, for=0, range=0, switch=0, typeSwitch=1, select=0, branch=0, assign=1, return=3, defer=0, go=0, call=4, binary=2, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `isShift` @ /usr/local/go1.27rc1/src/go/types/expr.go:239:1 - Present: FunctionDeclaration isShift (gojr/src/go/types/expr.ts) - control-flow shape: if=0, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=0, return=1, defer=0, go=0, call=0, binary=3, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `isComparison` @ /usr/local/go1.27rc1/src/go/types/expr.go:243:1 - Present: FunctionDeclaration isComparison (gojr/src/go/types/expr.ts) - control-flow shape: if=0, for=0, range=0, switch=1, typeSwitch=0, select=0, branch=0, assign=0, return=2, defer=0, go=0, call=0, binary=0, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
...
#### Types
- `trie` (*ast.MapType) - Present: ClassDeclaration trie (gojr/src/go/types/trie.ts) - structure: not yet 1:1-audited

#### Methods
- `trie.insert` @ /usr/local/go1.27rc1/src/go/types/trie.go:24:1 - Present: Method trie.insert (gojr/src/go/types/trie.ts) - control-flow shape: if=3, for=1, range=1, switch=0, typeSwitch=2, select=0, branch=0, assign=9, return=5, defer=0, go=0, call=11, binary=6, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `trie.pickValue` @ /usr/local/go1.27rc1/src/go/types/trie.go:86:1 - Present: Method trie.pickValue (gojr/src/go/types/trie.ts) - control-flow shape: if=0, for=0, range=1, switch=0, typeSwitch=0, select=0, branch=0, assign=1, return=1, defer=0, go=0, call=2, binary=0, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
...
- `*TypeParam.is` @ /usr/local/go1.27rc1/src/go/types/typeparam.go:157:1 - Present: Method TypeParam.is (gojr/src/go/types/typeparam.ts) - control-flow shape: if=0, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=0, return=1, defer=0, go=0, call=3, binary=0, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `*TypeParam.typeset` @ /usr/local/go1.27rc1/src/go/types/typeparam.go:165:1 - Present: Method TypeParam.typeset (gojr/src/go/types/typeparam.ts) - control-flow shape: if=0, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=0, return=1, defer=0, go=0, call=3, binary=0, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
...
#### Constants
- `unificationDepthLimit` - Present: Variable unificationDepthLimit (gojr/src/go/types/unify.ts) - logic: declaration-only
- `panicAtUnificationDepthLimit` - Present: Variable panicAtUnificationDepthLimit (gojr/src/go/types/unify.ts) - logic: declaration-only
- `enableCoreTypeUnification` - Present: Variable enableCoreTypeUnification (gojr/src/go/types/unify.ts) - logic: declaration-only
- `traceInference` - Present: Variable traceInference (gojr/src/go/types/unify.ts) - logic: declaration-only
- `assign` - Present: Variable assign (gojr/src/go/types/unify.ts) - logic: declaration-only
- `exact` - Present: Variable exact (gojr/src/go/types/unify.ts) - logic: declaration-only
...
- `typeParamsById.Len` @ /usr/local/go1.27rc1/src/go/types/unify.go:182:1 - Present: Method typeParamsById.Len (gojr/src/go/types/unify.ts) - control-flow shape: if=0, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=0, return=1, defer=0, go=0, call=1, binary=0, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `typeParamsById.Less` @ /usr/local/go1.27rc1/src/go/types/unify.go:183:1 - Present: Method typeParamsById.Less (gojr/src/go/types/unify.ts) - control-flow shape: if=0, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=0, return=1, defer=0, go=0, call=0, binary=1, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `typeParamsById.Swap` @ /usr/local/go1.27rc1/src/go/types/unify.go:184:1 - Present: Method typeParamsById.Swap (gojr/src/go/types/unify.ts) - control-flow shape: if=0, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=1, return=0, defer=0, go=0, call=0, binary=0, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `*unifier.join` @ /usr/local/go1.27rc1/src/go/types/unify.go:189:1 - Present: Method unifier.join (gojr/src/go/types/unify.ts) - control-flow shape: if=1, for=0, range=0, switch=1, typeSwitch=0, select=0, branch=0, assign=1, return=2, defer=0, go=0, call=3, binary=5, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `*unifier.asBoundTypeParam` @ /usr/local/go1.27rc1/src/go/types/unify.go:215:1 - Present: Method unifier.asBoundTypeParam (gojr/src/go/types/unify.ts) - control-flow shape: if=2, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=2, return=2, defer=0, go=0, call=1, binary=1, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `*unifier.setHandle` @ /usr/local/go1.27rc1/src/go/types/unify.go:226:1 - Present: Method unifier.setHandle (gojr/src/go/types/unify.ts) - control-flow shape: if=1, for=0, range=1, switch=0, typeSwitch=0, select=0, branch=0, assign=2, return=0, defer=0, go=0, call=1, binary=2, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `*unifier.at` @ /usr/local/go1.27rc1/src/go/types/unify.go:237:1 - Present: Method unifier.at (gojr/src/go/types/unify.ts) - control-flow shape: if=0, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=0, return=1, defer=0, go=0, call=0, binary=0, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `*unifier.set` @ /usr/local/go1.27rc1/src/go/types/unify.go:243:1 - Present: Method unifier.set (gojr/src/go/types/unify.ts) - control-flow shape: if=1, for=0, range=0, switch=0, typeSwitch=0, select=0, branch=0, assign=1, return=0, defer=0, go=0, call=2, binary=1, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `*unifier.unknowns` @ /usr/local/go1.27rc1/src/go/types/unify.go:252:1 - Present: Method unifier.unknowns (gojr/src/go/types/unify.ts) - control-flow shape: if=1, for=0, range=1, switch=0, typeSwitch=0, select=0, branch=0, assign=1, return=1, defer=0, go=0, call=0, binary=1, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `*unifier.inferred` @ /usr/local/go1.27rc1/src/go/types/unify.go:266:1 - Present: Method unifier.inferred (gojr/src/go/types/unify.ts) - control-flow shape: if=0, for=0, range=1, switch=0, typeSwitch=0, select=0, branch=0, assign=2, return=1, defer=0, go=0, call=3, binary=0, unary=0, composite=0, funcLiteral=0 - logic: not yet 1:1-audited
- `*unifier.nify` @ /usr/local/go1.27rc1/src/go/types/unify.go:287:1 - Present: Method unifier.nify (gojr/src/go/types/unify.ts) - control-flow shape: if=62, for=2, range=7, switch=2, typeSwitch=1, select=0, branch=0, assign=56, return=40, defer=1, go=0, call=111, binary=95, unary=15, composite=2, funcLiteral=1 - logic: not yet 1:1-audited
...
#### Constants
- `isTypes2` - Present: Variable isTypes2 (gojr/src/go/types/util.ts) - logic: declaration-only
