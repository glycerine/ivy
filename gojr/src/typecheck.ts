...
function iterPackage(): GoTypesPackage {
  const pkg = NewPackage("iter", "iter");
  if (pkg.Scope().Lookup("Pull") !== null) return pkg;
  const boolType = Typ[Bool]!;

  const seqV = NewTypeParam(NewTypeName(NoPos, pkg, "V", null), emptyInterface);
  const seqYield = NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "value", seqV)),
    NewTuple(NewVar(NoPos, pkg, "", boolType)),
    false
  );
  const seqName = NewTypeName(NoPos, pkg, "Seq", null);
  const seqType = NewNamed(seqName, NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "yield", seqYield)),
    null,
    false
  ), null);
  ...
  const seq2Yield = NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "key", seq2K), NewVar(NoPos, pkg, "value", seq2V)),
    NewTuple(NewVar(NoPos, pkg, "", boolType)),
    false
  );
  const seq2Name = NewTypeName(NoPos, pkg, "Seq2", null);
  const seq2Type = NewNamed(seq2Name, NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "yield", seq2Yield)),
    null,
    false
  ), null);
  ...
  const pullYield = NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "value", pullV)),
    NewTuple(NewVar(NoPos, pkg, "", boolType)),
    false
  );
  const pullSeq = NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "yield", pullYield)),
    null,
    false
  );
  const pullNext = NewSignatureType(
    null,
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "value", pullV), NewVar(NoPos, pkg, "ok", boolType)),
    false
  );
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Pull", NewSignatureType(
    null,
    null,
    [pullV],
    NewTuple(NewVar(NoPos, pkg, "seq", pullSeq)),
    NewTuple(
      NewVar(NoPos, pkg, "next", pullNext),
      NewVar(NoPos, pkg, "stop", NewSignatureType(null, null, null, null, null, false))
    ),
    false
  )));
  ...
  const pull2Yield = NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "key", pull2K), NewVar(NoPos, pkg, "value", pull2V)),
    NewTuple(NewVar(NoPos, pkg, "", boolType)),
    false
  );
  const pull2Seq = NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "yield", pull2Yield)),
    null,
    false
  );
  const pull2Next = NewSignatureType(
    null,
    null,
    null,
    null,
    NewTuple(
      NewVar(NoPos, pkg, "key", pull2K),
      NewVar(NoPos, pkg, "value", pull2V),
      NewVar(NoPos, pkg, "ok", boolType)
    ),
    false
  );
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Pull2", NewSignatureType(
    null,
    null,
    [pull2K, pull2V],
    NewTuple(NewVar(NoPos, pkg, "seq", pull2Seq)),
    NewTuple(
      NewVar(NoPos, pkg, "next", pull2Next),
      NewVar(NoPos, pkg, "stop", NewSignatureType(null, null, null, null, null, false))
    ),
    false
  )));
...
function fmtPackage(): GoTypesPackage {
  ...
  const writerType = NewInterfaceType([
    NewFunc(NoPos, pkg, "Write", NewSignatureType(
      null,
      null,
      null,
      NewTuple(NewVar(NoPos, pkg, "p", byteSliceType)),
  ...
  const fprintfSig = NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "w", writerType), NewVar(NoPos, pkg, "format", stringType), NewVar(NoPos, pkg, "args", argsType)),
    NewTuple(NewVar(NoPos, pkg, "", intType), NewVar(NoPos, pkg, "", errorType)),
    true
  );
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Errorf", NewSignatureType(
    ...
    null,
    NewTuple(NewVar(NoPos, pkg, "format", stringType), NewVar(NoPos, pkg, "args", argsType)),
    NewTuple(NewVar(NoPos, pkg, "", errorType)),
    true
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Sprint", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "args", argsType)),
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Sprintln", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "args", argsType)),
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Append", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "b", byteSliceType), NewVar(NoPos, pkg, "args", argsType)),
    NewTuple(NewVar(NoPos, pkg, "", byteSliceType)),
    true
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Appendf", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "b", byteSliceType), NewVar(NoPos, pkg, "format", stringType), NewVar(NoPos, pkg, "args", argsType)),
    NewTuple(NewVar(NoPos, pkg, "", byteSliceType)),
    true
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Appendln", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "b", byteSliceType), NewVar(NoPos, pkg, "args", argsType)),
...
function runtimePackage(): GoTypesPackage {
  ...
  funcType.AddMethod(NewFunc(NoPos, pkg, "Entry", NewSignatureType(
    funcRecv,
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "", uintptrType)),
    false
  )));
  funcType.AddMethod(NewFunc(NoPos, pkg, "FileLine", NewSignatureType(
    funcRecv,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "pc", uintptrType)),
    NewTuple(NewVar(NoPos, pkg, "file", stringType), NewVar(NoPos, pkg, "line", intType)),
    false
  )));
  funcType.AddMethod(NewFunc(NoPos, pkg, "Name", NewSignatureType(
    funcRecv,
    null,
    null,
    null,
  ...
  framesType.AddMethod(NewFunc(NoPos, pkg, "Next", NewSignatureType(
    framesRecv,
    null,
    null,
    null,
  ...
  const runtimeErrorInterface = NewInterfaceType([
    NewFunc(NoPos, pkg, "RuntimeError", NewSignatureType(
      null,
      null,
      null,
      null,
  ...
  cleanupType.AddMethod(NewFunc(NoPos, pkg, "Stop", NewSignatureType(
    cleanupRecv,
    null,
    null,
    null,
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Caller", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "skip", intType)),
    NewTuple(
      NewVar(NoPos, pkg, "pc", uintptrType),
      NewVar(NoPos, pkg, "file", stringType),
      NewVar(NoPos, pkg, "line", intType),
      NewVar(NoPos, pkg, "ok", boolType)
    ),
    false
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Callers", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "skip", intType), NewVar(NoPos, pkg, "pc", uintptrSliceType)),
    NewTuple(NewVar(NoPos, pkg, "", intType)),
    false
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "CallersFrames", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "callers", uintptrSliceType)),
    NewTuple(NewVar(NoPos, pkg, "", NewPointer(framesType))),
    false
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "FuncForPC", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "pc", uintptrType)),
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "AddCleanup", NewSignatureType(
    ...
    [cleanupT, cleanupS],
    NewTuple(
      NewVar(NoPos, pkg, "ptr", NewPointer(cleanupT)),
      NewVar(NoPos, pkg, "cleanup", NewSignatureType(
        null,
        null,
        null,
        NewTuple(NewVar(NoPos, pkg, "", cleanupS)),
        null,
        false
      )),
      NewVar(NoPos, pkg, "arg", cleanupS)
    ),
    NewTuple(NewVar(NoPos, pkg, "", cleanupType)),
    false
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "GC", NewSignatureType(
    null,
    null,
    null,
    null,
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "GOMAXPROCS", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "n", intType)),
    NewTuple(NewVar(NoPos, pkg, "", intType)),
    false
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "GOROOT", NewSignatureType(
    null,
    null,
    null,
    null,
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Goexit", NewSignatureType(
    null,
    null,
    null,
    null,
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "KeepAlive", NewSignatureType(
    null,
    null,
    null,
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "NumGoroutine", NewSignatureType(
    null,
    null,
    null,
    null,
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "ReadMemStats", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "m", NewPointer(memStatsType))),
    null,
    false
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "ReadTrace", NewSignatureType(
    null,
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "buf", byteSliceType)),
    false
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "SetBlockProfileRate", NewSignatureType(
    null,
    null,
    null,
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "SetFinalizer", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "obj", emptyInterface), NewVar(NoPos, pkg, "finalizer", emptyInterface)),
    null,
    false
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "SetMutexProfileFraction", NewSignatureType(
    null,
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "rate", intType)),
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "StartTrace", NewSignatureType(
    null,
    null,
    null,
    null,
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "StopTrace", NewSignatureType(
    null,
    null,
    null,
    null,
  ...
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Stack", NewSignatureType(
    ...
    null,
    null,
    NewTuple(NewVar(NoPos, pkg, "buf", byteSliceType), NewVar(NoPos, pkg, "all", boolType)),
    NewTuple(NewVar(NoPos, pkg, "", intType)),
    false
  )));
  pkg.Scope().Insert(NewFunc(NoPos, pkg, "Version", NewSignatureType(
    null,
    null,
    null,
    null,
...
function testingPackage(): GoTypesPackage {
  ...
  const addMethod = (targetType: ReturnType<typeof NewNamed>, receiver: ReturnType<typeof NewVar>, name: string, result: GoTypesType | null, parameters: ReturnType<typeof NewVar>[] = [], variadic = false): void => {
  ...
  const addCommonMethods = (targetType: ReturnType<typeof NewNamed>, receiver: ReturnType<typeof NewVar>, receiverPtrType: GoTypesType): void => {
    ...
    addMethod(targetType, receiver, "Run", boolType, [
      ...
      NewVar(NoPos, pkg, "f", NewSignatureType(
        null,
        null,
        null,
        NewTuple(NewVar(NoPos, pkg, "", receiverPtrType)),
        null,
        false
      ))
    ]);
