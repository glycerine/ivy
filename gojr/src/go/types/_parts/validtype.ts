...
declare module "./check.js" {
  interface Checker {
    validType(typ: Named): void;
    validType0(pos: Pos, typ: Type | null, nest: Named[] | null, path: Named[] | null): boolean;
  }
}
...
declare module "./check.js" {
  interface Checker {
    validType0Body(pos: Pos, typ: Type | null, nest: Named[], path: Named[]): boolean;
  }
}
...
// list of named types.
export function makeObjList(tlist: Named[]): Object[] {
  const olist = new globalThis.Array<Object>(tlist.length);
