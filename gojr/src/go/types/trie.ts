...
export class trie<V> extends Map<number, trie<V> | V | null> {
  ...
  public insert(key: number[], val: V): [V, number] {
    let tr: trie<V> = this;
  ...
  public pickValue(): trie<V> | V | null {
