...
// and false for all versions <= 1.6
// For example, a file "#lang ivy1.6" will return above16 == false,
// but #lang ivy1.7 will return above16 true.
func IvyVersionSupported(path string) (above16 bool, err error) {
	f, err := os.Open(path)
	if err != nil {
		return false, err
	}
