...
func TestGetSortRefinement_StructuralKeys(t *testing.T) {
	...
	sortA := &UninterpretedSort{Name: "mytype"}
	canonical := &UninterpretedSort{Name: "canonical"}
