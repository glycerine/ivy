...
export async function init(initModule: any) {
  ...
  return {
    ...
    Z3: {
      ...
      global_param_get: function (param_id: string): string | null | null {
        let ret = Mod.ccall(
          'Z3_global_param_get',
          'boolean',
          ['string', 'number'],
      ...
      get_parser_error: function (c: Z3_context): string {
        return Mod.ccall('Z3_get_parser_error', 'string', ['number'], [c]);
      },
      ...
      apply_result_convert_model: Mod._Z3_apply_result_convert_model as (
        c: Z3_context,
        r: Z3_apply_result,
        i: unsigned,
        m: Z3_model,
      ...
      fixedpoint_push: Mod._Z3_fixedpoint_push as (
        c: Z3_context,
        d: Z3_fixedpoint,
      ) => void,
      fixedpoint_pop: Mod._Z3_fixedpoint_pop as (
        c: Z3_context,
        d: Z3_fixedpoint,
      ) => void,
      ...
      optimize_check: function (
        ...
        return Mod.async_call(Mod._async_Z3_optimize_check, c, o);
      },
