...
top:
    ...
    | top PARSER_TOK_INCLUDE SYMBOLx
    {
        ...
        $$ = $1
        lex := parser17lex.(*parser17LexAdapter)
        parserDeclareInclude(parser17Acfg(parser17lex), $$, lex.accum, lex.importer, $3.Val, tokLineno(lex, $2))
    }
    ...
    | top optexplicit opttemporal PARSER_TOK_AXIOM lgprop
    {
        ...
        $$ = $1
        parser17DeclareAxiom(parser17Acfg(parser17lex), $$, $5.(*LabeledFormula), $2 != nil, $3 != nil, tokLineno(parser17lex.(*parser17LexAdapter), $4))
    }
    ...
    | top optexplicit opttemporal PARSER_TOK_PROPERTY labeledfmla optskolem optproof
    {
        ...
        $$ = $1
        parser17DeclareProperty(parser17Acfg(parser17lex), $$, $5.(*LabeledFormula), $2 != nil, $3 != nil, tokLineno(parser17lex.(*parser17LexAdapter), $4), $6, $7)
    }
    // --- Conjecture ---
    | top PARSER_TOK_CONJECTURE labeledfmla
    {
        ...
        $$ = $1
        parser17DeclareConjecture(parser17Acfg(parser17lex), $$, $3.(*LabeledFormula), tokLineno(parser17lex.(*parser17LexAdapter), $2))
    }
    ...
    | top optexplicit PARSER_TOK_INVARIANT labeledfmla optproof
    {
        ...
        $$ = $1
        parser17DeclareInvariant(parser17Acfg(parser17lex), $$, $4.(*LabeledFormula), $2 != nil, tokLineno(parser17lex.(*parser17LexAdapter), $3), $5)
    }
    ...
    | top PARSER_TOK_UNPROVABLE PARSER_TOK_INVARIANT labeledfmla optproof
    {
        ...
        $$ = $1
        parser17DeclareUnprovableInvariant(parser17Acfg(parser17lex), $$, $4.(*LabeledFormula), $5)
    }
    ...
    | top optimpex actmeth SYMBOLx optargs optreturns optactiondef
    {
        ...
        $$ = $1
        parser17DeclareAction(parser17Acfg(parser17lex), $$, $2, $3, $4.Val, $5, $6, $7, tokLineno(parser17lex.(*parser17LexAdapter), $4))
    }
    // --- Mixin before ---
