...
func (i *Implies) Canon() Canonical {
...
func (g *Globally) Canon() Canonical {
...
func (e *Eventually) Canon() Canonical {
...
func (w *WhenOperator) Canon() Canonical {
...
func (d *Definition) Canon() Canonical {
...
func (d *DefinitionSchema) Canon() Canonical {
	return Canonical(fmt.Sprintf("(definitionSchema definition:%v)", d.Definition.Canon()))
}
...
func (n *NamedBinder) Canon() Canonical {
...
func (t *Trigger) Canon() Canonical {
