...
func (s *Solver) buildConstraintTerm(sym lg.Expr) lg.Expr {
...
func (s *Solver) natConstraintForSymbol(sym lg.Expr) []lg.Expr {
	if s.sig == nil {
		return nil
	}
	rng := il.SortRange(sym.NodeSort())
	if rng == nil {
		return nil
	}
...
func (s *Solver) rangeConstraintsForSymbol(sym lg.Expr) []lg.Expr {
	if s.sig == nil {
		return nil
	}
	rng := il.SortRange(sym.NodeSort())
