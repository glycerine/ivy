...
func TestGetTheorySchemataInt(t *testing.T) {
	s := GetTheorySchemata("int", &UninterpretedSort{Name: "int"}, "1.7")
	if s == "" {
...
func TestGetTheorySchemataBV(t *testing.T) {
	s := GetTheorySchemata("bv[32]", &UninterpretedSort{Name: "bv32"}, "1.7")
	if s == "" {
...
func TestGetTheorySchemataNat(t *testing.T) {
	s := GetTheorySchemata("nat", &UninterpretedSort{Name: "nat"}, "1.7")
	if s == "" {
...
func TestGetTheorySchemataOldVersion(t *testing.T) {
	s := GetTheorySchemata("int", &UninterpretedSort{Name: "int"}, "1.5")
	if s != "" {
...
func TestGetTheorySchemataUnknown(t *testing.T) {
	s := GetTheorySchemata("custom", &UninterpretedSort{Name: "custom"}, "1.7")
	if s != "" {
...
func TestGetSortTheoryWithInterp(t *testing.T) {
	sort := &UninterpretedSort{Name: "myint"}
...
func TestHasIntegerInterpNat(t *testing.T) {
	sort := &UninterpretedSort{Name: "mynat"}
...
func TestHasIntegerInterpRange(t *testing.T) {
	sort := &UninterpretedSort{Name: "idx"}
	rs := &RangeSort{Name: "idx", Lb: NumeralBound{Value: "0"}, Ub: NumeralBound{Value: "10"}}
...
func TestHasIntegerInterpFalse(t *testing.T) {
	sort := &UninterpretedSort{Name: "foo"}
