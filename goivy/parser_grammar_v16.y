...
optproof:
    ...
    | PARSER16_TOK_PROOF labelname proofstep
    {
        ...
        label.SetLineno(tok16Lineno(parser16lex.(*parser16LexAdapter), $2))
...
topseq:
    ...
    | PARSER16_TOK_LCB PARSER16_TOK_NATIVEQUOTE PARSER16_TOK_RCB
    {
        ...
        na.SetLineno(tok16Lineno(parser16lex.(*parser16LexAdapter), $2))
        $$ = na
    }
    ;
...
oper:
    ...
    | relop
    {
        ...
        $$ = parser16NodeAt(parser16Acfg(parser16lex).NewAtom($1.Val), tok16Lineno(parser16lex.(*parser16LexAdapter), $1))
    }
    | infix
    {
...
optactiondef:
    ...
    | PARSER16_TOK_EQ PARSER16_TOK_TIMES
    {
        ...
        ca.SetLineno(tok16Lineno(parser16lex.(*parser16LexAdapter), $2))
        $$ = ca
    }
    ;
...
defnlhs:
    ...
    | PARSER16_TOK_LPAREN defarg relop defarg PARSER16_TOK_RPAREN
    {
        ...
        $$ = parser16NodeAt(parser16Acfg(parser16lex).NewAtom($3.Val, $2, $4), tok16Lineno(parser16lex.(*parser16LexAdapter), $3))
    }
...
tapp:
    ...
    | SYMBOLx targs
    {
        ...
        copy(args, $2)
        a := parser16Acfg(parser16lex).NewApp(parser16Acfg(parser16lex).NewSymbol($1, nil), args...)
        $$ = a
    }
...
expr:
    ...
    | exprterm relop exprterm
    {
        ...
        atom := parser16NodeAt(parser16Acfg(parser16lex).NewAtom($2.Val, $1, $3), tok16Lineno(parser16lex.(*parser16LexAdapter), $2))
