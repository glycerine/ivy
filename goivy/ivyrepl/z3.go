...
func installZ3(env *zlisp.Zlisp) {
	addFunctions(env, map[string]zlisp.ZlispUserFunction{
		"z3-new-context":           z3NewContext,
		"z3-new-interp-context":    z3NewInterpolationContext,
		"z3-close":                 z3Close,
		"z3-interrupt":             z3Interrupt,
		"z3-bool-sort":            z3BoolSort,
		"z3-int-sort":             z3IntSort,
		"z3-real-sort":            z3RealSort,
		"z3-string-sort":          z3StringSort,
		"z3-bv-sort":              z3BvSort,
		"z3-uninterpreted-sort":   z3UninterpretedSort,
		"z3-array-sort":           z3ArraySort,
		"z3-array-domain":         z3ArrayDomain,
		"z3-array-range":          z3ArrayRange,
		"z3-is-bv-sort":           z3IsBvSort,
		"z3-bv-sort-size":         z3BvSortSize,
		"z3-const":                z3Const,
		"z3-bool":                 z3BoolVal,
		"z3-int":                  z3IntVal,
		"z3-string":               z3StringVal,
		"z3-bv":                   z3BvVal,
		"z3-enum-sort":            z3EnumSort,
		"z3-function":             z3Function,
		"z3-apply":                z3Apply,
		"z3-func-as-expr":         z3FuncAsExpr,
		"z3-not":                  z3Not,
		"z3-and":                  z3And,
		"z3-and-app":              z3AndApp,
		"z3-or":                   z3Or,
		"z3-implies":              z3Implies,
		"z3-iff":                  z3Iff,
		"z3-eq":                   z3Eq,
		"z3-ite":                  z3Ite,
		"z3-add":                  z3Add,
		...
		"z3-bv-ugt":               z3BvUgt,
		"z3-bv-uge":               z3BvUge,
		"z3-is-bv-expr":           z3IsBvExpr,
		"z3-forall":               z3ForAll,
		"z3-exists":               z3Exists,
		"z3-select":               z3Select,
		"z3-store":                z3Store,
		"z3-const-array":          z3ConstArray,
		"z3-new-solver":           z3NewSolver,
		"z3-new-solver-for-logic": z3NewSolverForLogic,
		"z3-assert":               z3Assert,
		"z3-check":                z3Check,
		"z3-push":                 z3Push,
		"z3-pop":                  z3Pop,
		"z3-reset":                z3Reset,
		"z3-solver-string":        z3SolverString,
		"z3-solver-smt2":          z3SolverSMT2,
		"z3-reason-unknown":       z3ReasonUnknown,
		"z3-set-param":            z3SetParam,
		"z3-check-assumptions":    z3CheckAssumptions,
		"z3-unsat-core":           z3UnsatCore,
		"z3-canon-assertions":     z3CanonAssertions,
		"z3-model":                z3Model,
		"z3-model-eval":           z3ModelEval,
		"z3-model-sorts":          z3ModelSorts,
		"z3-model-universe":       z3ModelUniverse,
		"z3-model-string":         z3ModelString,
		"z3-expr-string":          z3ExprString,
		"z3-expr-equal":           z3ExprEqual,
		"z3-expr-true?":           z3ExprIsTrue,
		"z3-expr-false?":          z3ExprIsFalse,
		"z3-substitute":           z3Substitute,
		"z3-mk-interpolant":       z3MkInterpolant,
		"z3-compute-interpolant":  z3ComputeInterpolant,
	})
}
