...
//
// It intentionally does not compare against Python Ivy. It is just a stable
// command-line producer of the wasm Go Ivy stdout/stderr stream, so golden
// tests can compare it using the same style as parser_golden_test.go.
