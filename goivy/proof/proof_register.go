...
func RegisterFactories(modCfg *module.Config, proofCfg *module.ProofConfig) {
	...
	modCfg.NewProofCheckerFn = func(mod *module.Module, axioms, definitions []*ast.LabeledFormula, schemata *iu.InsMap[string, *ast.LabeledFormula]) module.ProofCheckerInterface {
