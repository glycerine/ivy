...
func (s *SchemaInstantiation) Canon() Canonical {
	return Canonical(fmt.Sprintf("(schemaInstantiation%v schemaName:%v ren:%v matches:%v)", s.Base.canonFields(), nodeCanon(s.SchemaName), nodeCanon(s.Ren), SliceCanon(s.Matches)))
}
...
func (a *AssumeTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(assumeTactic%v tLabel:%v schemaName:%v ren:%v matches:%v)", a.Base.canonFields(), nodeCanon(a.TLabel), nodeCanon(a.SchemaName), nodeCanon(a.Ren), SliceCanon(a.Matches)))
}
...
func (u *UnfoldSpec) Canon() Canonical {
	return Canonical(fmt.Sprintf("(unfoldSpec%v defName:%v renamings:%v)", u.Base.canonFields(), nodeCanon(u.DefName), SliceCanon(u.Renamings)))
}
...
func (u *UnfoldTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(unfoldTactic%v tLabel:%v premise:%v unfSpecs:%v)", u.Base.canonFields(), nodeCanon(u.TLabel), nodeCanon(u.Premise), SliceCanon(u.UnfSpecs)))
}
...
func (f *ForgetTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(forgetTactic%v names:%v)", f.Base.canonFields(), SliceCanon(f.Names)))
}
...
func (s *ShowGoalsTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(showGoalsTactic%v)", s.Base.canonFields()))
}
...
func (d *DeferGoalTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(deferGoalTactic%v elems:%v)", d.Base.canonFields(), SliceCanon(d.Elems)))
}
...
func (n *NullTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(nullTactic%v)", n.Base.canonFields()))
}
...
func (l *LetTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(letTactic%v defs:%v)", l.Base.canonFields(), SliceCanon(l.Defs)))
}
...
func (w *WitnessTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(witnessTactic%v witnesses:%v)", w.Base.canonFields(), SliceCanon(w.Witnesses)))
}
...
func (s *SpoilTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(spoilTactic%v target:%v)", s.Base.canonFields(), nodeCanon(s.Target)))
}
...
func (i *IfTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(ifTactic%v cond:%v then:%v else:%v)", i.Base.canonFields(), nodeCanon(i.Cond), nodeCanon(i.Then), nodeCanon(i.Else)))
}
...
func (p *PropertyTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(propertyTactic%v prop:%v pName:%v proof:%v)", p.Base.canonFields(), nodeCanon(p.Prop), nodeCanon(p.PName), nodeCanon(p.Proof)))
}
...
func (f *FunctionTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(functionTactic%v elems:%v)", f.Base.canonFields(), SliceCanon(f.Elems)))
}
...
func (tw *TacticWith) Canon() Canonical {
	return Canonical(fmt.Sprintf("(tacticWith%v elems:%v)", tw.Base.canonFields(), SliceCanon(tw.Elems)))
}
...
func (tl *TacticLets) Canon() Canonical {
	return Canonical(fmt.Sprintf("(tacticLets%v lets:%v)", tl.Base.canonFields(), SliceCanon(tl.Lets)))
}
...
func (t *TacticTactic) Canon() Canonical {
	return Canonical(fmt.Sprintf("(tacticTactic%v tName:%v body:%v proof:%v labels:%v)", t.Base.canonFields(), nodeCanon(t.TName), nodeCanon(t.Body), nodeCanon(t.Proof), astStringSliceCanon(t.Labels)))
}
...
func (c *ComposeTactics) Canon() Canonical {
	return Canonical(fmt.Sprintf("(composeTactics%v tactics:%v)", c.Base.canonFields(), SliceCanon(c.Tactics)))
}
