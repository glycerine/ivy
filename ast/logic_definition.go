...
// LogicDefinition represents a formula of the form lhs = rhs (or lhs <-> rhs).
...
func NewLogicDefinition(lhs, rhs Expr) *LogicDefinition {
...
// LogicDefinitionSchema is a parametrized definition.
type LogicDefinitionSchema struct {
	LogicDefinition
}

func NewLogicDefinitionSchema(lhs, rhs Expr) *LogicDefinitionSchema {
